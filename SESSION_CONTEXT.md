...
| **CRM телефоны** | ⏳ организационное | Менеджеры вносят телефоны через `/phone` в 18:00 — CRM автозаполнит при наличии отчётов |
| **Chat not found (analitic)** | ⏳ организационное | Оксана/Магира/Ергали → написать `/start` боту |
