...
.stat{{background:#eef2f8;padding:16px;border-radius:8px;text-align:center}}
.stat-value{{font-size:26px;font-weight:700;color:#1a3a5c}}
.stat-label{{font-size:12px;color:#64748b;text-transform:uppercase;margin-top:6px}}
...
<div class="footer"><strong>AI 1C PRO</strong> | rfm_clients_report.py v{__VERSION__} | {datetime.now(TZ).strftime("%d.%m.%Y %H:%M")} (Asia/Almaty)</div>
</div>
</body>
</html>"""
