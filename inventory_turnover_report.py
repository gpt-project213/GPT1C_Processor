...
.alert{{background:#fff8e6;border:1px solid #e09000;padding:16px;border-radius:8px;margin:16px 0}}
.alert.danger{{background:#fff0f0;border-color:#c00000}}
.alert-value{{font-size:30px;font-weight:700;color:#c00000;margin:8px 0}}
table{{width:100%;border-collapse:collapse;margin:16px 0}}
th,td{{padding:8px 10px;border-bottom:1px solid #d0d9e8;text-align:left}}
