...
- tracked files count: 67

---

## 4. Current priority

- opportunity loss analytics for debt silence greater than 15 days
- debt threshold greater than 10000 KZT
- margin = gross_profit / revenue
- monthly opportunity loss = debt * margin
- daily opportunity loss = (debt * margin) / 30
